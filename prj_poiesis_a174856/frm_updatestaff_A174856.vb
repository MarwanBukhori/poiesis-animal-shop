Public Class frm_updatestaff_A174856
    Dim current_id As String

    Private Sub frm_updatestaff_A174856_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        refresh_grid()
    ...
    Private Sub btn_update_Click(sender As Object, e As EventArgs) Handles btn_update.Click
        ...
        run_sql_command("UPDATE TBL_STAFF_A174856 SET FLD_STAFF_NAME='" & txt_name.Text & "', FLD_STAFF_PHONE ='" & txt_no.Text & "', FLD_ADDRESS='" & txt_address.Text & "'WHERE FLD_STAFF_ID='" & current_id & "'")
        Beep()
    ...
    Private Sub btn_delete_Click(sender As Object, e As EventArgs) Handles btn_delete.Click
        ...
        If delete_confirmation = MsgBoxResult.Yes Then
            run_sql_command("DELETE FROM TBL_STAFF_A174856 WHERE FLD_STAFF_ID='" & current_id & "'")
            Beep()
